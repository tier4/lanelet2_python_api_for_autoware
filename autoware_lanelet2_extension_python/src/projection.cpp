...
BOOST_PYTHON_MODULE(_lanelet2_extension_python_boost_python_projection)
{
  ...
  bp::class_<
    ...
    .def(
      "setMGRSCode",
      static_cast<void (lanelet::projection::MGRSProjector::*)(const std::string &)>(
        &lanelet::projection::MGRSProjector::setMGRSCode),
      "Sets MGRS code used for reverse projection")
    .def(
      "setMGRSCode",
      static_cast<void (lanelet::projection::MGRSProjector::*)(
        const lanelet::GPSPoint &, const int)>(&lanelet::projection::MGRSProjector::setMGRSCode),
      (bp::arg("gps"), bp::arg("precision") = 0),
      "Sets MGRS code used for reverse projection from GPS lat/lon values")
    .def(
      "getProjectedMGRSGrid", &lanelet::projection::MGRSProjector::getProjectedMGRSGrid,
